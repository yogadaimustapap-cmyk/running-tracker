...
<head>
    ...
    <title>Catat Olahraga Baru - RunningTracker</title>
    <!-- Google Fonts -->
        ...
        <main class="main-content">
            <div class="dashboard-wrapper">
                ...
                <div class="header-section">
                    ...
                    <h2 class="page-title">Catat Olahraga Baru</h2>
                </div>
                ...
                <div class="form-card">
                    <form method="POST" action="{{ route('workout-logs.store') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" id="workout_date" name="workout_date" class="form-input" value="{{ old('workout_date', date('Y-m-d')) }}" required>
                            @error('workout_date')
                        ...
                        <div class="form-group">
                            ...
                            <select id="workout_type" name="workout_type" class="form-input" required>
                                <option value="" disabled {{ old('workout_type') == '' ? 'selected' : '' }}>Pilih Jenis Olahraga</option>
                                @foreach($types as $type)
                                    <option value="{{ $type }}" {{ old('workout_type') == $type ? 'selected' : '' }}>{{ $type }}</option>
                                @endforeach
                            </select>
                            @error('workout_type')
                                <div class="error-message">{{ $message }}</div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="duration" name="duration" class="form-input" placeholder="Misal: 30" value="{{ old('duration') }}" required min="1">
                            @error('duration')
                                <div class="error-message">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="distance" name="distance" class="form-input" step="0.01" placeholder="Misal: 5.25" value="{{ old('distance') }}" required min="0.01">
                            @error('distance')
                                <div class="error-message">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="notes" name="notes" class="form-input form-textarea" placeholder="Misal: Lari santai pagi hari di taman kota bersama teman.">{{ old('notes') }}</textarea>
                            @error('notes')
                                <div class="error-message">{{ $message }}</div>
                            @enderror
                        </div>
