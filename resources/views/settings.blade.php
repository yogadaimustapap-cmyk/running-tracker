...
<head>
    ...
    <title>Pengaturan Kota - RunningTracker</title>
    <!-- Google Fonts -->
        ...
        <aside class="sidebar">
            <div>
                ...
                <nav class="sidebar-menu">
                    ...
                    <a href="{{ route('weather.settings') }}" class="menu-item active">
                        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <main class="main-content">
            <div class="dashboard-wrapper">
                ...
                <div class="header-section">
                    <h2 class="page-title">Pengaturan Pemantauan Cuaca</h2>
                </div>

                <div class="form-card">
                    <form method="POST" action="{{ route('weather.settings.update') }}">
                        @csrf
